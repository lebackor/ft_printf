...
//a = atoi(av[1]);
// printf("\n%X\n", a);
//ft_printf("= %u\n", ft_printf("%p/%p/%p/%p/%p/%p/%p/%p/%p/%p/%p/%p/%p","-1", "1", "15", "16", "17", "-2147483647 - 1", "2147483647", "-2147483647 - 1", "2147483647", "4294967295", "-4294967295", "0", "0"));
//  printf("= %u\n", printf("%p/%p/%p/%p/%p/%p/%p/%p/%p/%p/%p/%p/%p","-1", "1", "15", "16", "17", "-2147483647 - 1", "2147483647", "-2147483647 - 1", "2147483647", "4294967295", "-4294967295", "0", "0"));
ft_printf(" = %d\n", ft_printf("%a", av[1]));
printf("\n                           DIFF                       \n");
printf(" = %d\n",  printf("%s", av[1]));
}*/